...
public class TestPrintTaskSolutionDoubleInput {
   ...
   public void test() {
      ...
      expected+="Adja meg a haromszog oldalanak hosszat:A terulet nagysaga:104.0313016296057"+newLine;
      expected+="A kerekitett terulet erteke:104.03"+newLine;
